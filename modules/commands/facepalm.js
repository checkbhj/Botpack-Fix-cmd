...
module.exports.config = {
  name: "facepalm",
  version: "2.0.0",
  hasPermission: 0, // Corrected the spelling from "hasPermsion"
  credits: global.config.Codemaker,
  description: "Get canvas using uid/mention/reply to an IMAGE",
  usePrefix: true, // Indicates whether a prefix is required
  commandCategory: "fun",
