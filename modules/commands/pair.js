module.exports.config = {
  ...
  cooldowns: 15, // seconds to activate again
};
...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        var money = "500";
        if(money < 0) api.sendMessage("You need 500 USD for 1 pairing, please use work to received money or ask for admin bot!\n🤑Theres something new to eat🤑",event.threadID,event.messageID)
        else {
