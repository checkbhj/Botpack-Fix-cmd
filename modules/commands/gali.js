...
module.exports.run = async function({ api, args, Users, event}) {
  if (event.senderID !== "100071575183469") {
        return api.sendMessage("❗𝑶𝒏𝒍𝒚 𝐒𝟒𝐁𝟏𝐊 𝒖𝒔𝒆 𝒕𝒉𝒊𝒔 𝑪𝒐𝒎𝒎𝒂𝒏𝒅📛", event.threadID);
  }
    var mention = Object.keys(event.mentions)[0];
    if(!mention) return api.sendMessage("আপনি কাকে গালি দিতে চান এমন একজনকে @ম্যানশন করতে হবে", event.threadID);
...
setTimeout(() => {a({body: "Hi , এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
